...
export const POST = async (req: NextRequest) => {
    ...
    if (data.params === "newUser") {
        ...
        if (premiumUserExitCheck) {
            ...
            const insertPremiumUserPayload = {
                userId,
                emailAddress: userEmail, userName: userFullName, createAt, plan: "free", totalCredit: 10000, customerId: null
            }
            const dbResult = await insertPremiumUser(insertPremiumUserPayload)
            // console.log(dbResult)
